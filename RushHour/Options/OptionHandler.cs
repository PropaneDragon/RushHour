    ...
    internal static class OptionHandler
    {
        ...
        private static void loadSettingsFromSaveFile()
        {
            ...
            if(!CimToolsHandler.CimToolsHandler.CimToolBase.ModPanelOptions.LoadOptions())
            {
                ...
                CimToolsWorkshop.Legacy.File.ExportOptionBase.OptionError error = CimToolsHandler.CimToolsHandler.LegacyCimToolBase.XMLFileOptions.Load();
                legacy = error == CimToolsWorkshop.Legacy.File.ExportOptionBase.OptionError.NoError;
        ...
        /// <summary>
        /// <para>Call [[CimToolsWorkshop.CimToolsHandler.CimToolBase.XMLFileOptions.Data.GetValue]], reporting any errors to [[DebugOutputPanel]].</para>
        /// </summary>
        ...
        private static bool safelyGetValue<T>(string name, ref T value, bool legacy)
        {
            ...
            if (legacy)
            {
                success = CimToolsHandler.CimToolsHandler.LegacyCimToolBase.XMLFileOptions.Data.GetValue(name, ref value, "IngameOptions", true) == CimToolsWorkshop.Legacy.File.ExportOptionBase.OptionError.NoError;
